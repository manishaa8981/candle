...
//
// class Header extends Component<{ itemCount: any }> {
//     render() {
...
// }
//
// class ProductList extends Component<{ products: any, onChangeProductQuantity: any, onRemoveProduct: any }> {
//     render() {
//         let {products, onChangeProductQuantity, onRemoveProduct} = this.props;
//         return (
