...
//     return (
//         <div className="flex">
//             <div className="w-1/5 bg-gray-200 p-4 navbar">
//                 {/* Your sidebar content goes here */}
//                 <nav className="space-y-2">
//                     <NavLink to="/" className="block py-2">Home</NavLink>
//                     <NavLink to="/AboutUs" className="block py-2">About Us</NavLink>
//                     <NavLink to="/Contact" className="block py-2">Contact</NavLink>
//                     <NavLink to="/Cart" className="block py-2">Cart</NavLink>
//                     <NavLink to="/LoginForm" className="block py-2">Login</NavLink>
//                 </nav>
//             </div>
//             <div className="w-4/5 p-4">
//                 {/* Include the HomeNavbar component here */}
//                 <HomeNavbar />
//
//             </div>
//         </div>
